...
const CACHE_NAME = "receipt-book-cache-20260131103633";
const CORE_ASSETS = ['./', './index.html', './app.20260131103633.js', './style.css', './icons/icon-192.png', './icons/icon-512.png', './manifest.webmanifest'];
